...
var sum=(e)=>{
var inputId=document.getElementById('inputData').value
var numberedResult=eval(inputId)
...
var cl2=()=>{
    ...
    return(<div>
            <center>
                ...
                {/* <input value={cal} placeholder="value" style={{display:"disable"}}></input><br></br> */}
             ...
             <button onClick={cl2} >b</button><br></br>
                ...
                <button onClick={()=>setcal(cal+"4")} style={{height:"50px",width:"50px"}}>4</button><br></br>
                ...
                <button onClick={()=>setcal(cal+"9")} style={{height:"50px",width:"50px"}}>9</button><br></br>
